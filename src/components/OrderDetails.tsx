  ...
  return (
    <div className="bg-gradient-to-r from-gray-800 via-gray-900 to-black shadow-xl mb-6 p-10 border border-gray-700 text-left">
      ...
      <div className="bg-gradient-to-r from-gray-800 via-gray-900 to-black p-6 rounded-2xl shadow-xl mb-6 border border-gray-700 text-left">
        ...
        <p><strong className="font-semibold text-blue-200">Status:</strong> {order.status}</p>
        <p><strong className="font-semibold text-blue-200">Método de Entrega:</strong> {order.shipping_method}</p>
        <p><strong className="font-semibold text-blue-200">Data Estimada de Entrega:</strong> {formattedDate}</p>
      ...
      <div className="bg-gradient-to-r from-gray-800 via-gray-900 to-black p-6 rounded-2xl shadow-xl mb-6 border border-gray-700 text-left">
        ...
        <p><strong className="font-semibold text-blue-200">Nome:</strong> {order.customer.name}</p>
